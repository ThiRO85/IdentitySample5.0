...
{
    public class ClienteWizardOn : Entity
    {
        ...
        public ClienteWizardOn IndicadoPor { get; set; }
        ...
        public virtual ICollection<OcorrenciaWizardOn> OcorrenciaWizardOns { get; set; }

        public ClienteWizardOn()
        {
            OcorrenciaWizardOns = new Collection<OcorrenciaWizardOn>();
            Ativo = true;
